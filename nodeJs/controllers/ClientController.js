...
function ClientController() {
  ...
  //       { new: true }
  //     )
  //     const filterValueTrue = await CommenteModel.aggregate([
  ...
  //     ])
  //     falseLike.answer[0].likeCount = filterValueTrue.length
  //     await falseLike.save()
  //     res.status(200).json({ value: filterValueTrue.length })
  //   }
  //   else if (falseLike) {
  ...
  //       {$unwind: '$answer' },
  //       {$match: { 'answer._id': mongoose.Types.ObjectId(req.query.commentId) } },
  //       {$unwind: '$answer.disLike' },
  //       {$match: {'answer.disLike.value': 1 }} 
  //     ])
  //     falseLike.answer[0].disLikeCount = filterValueTrue.length
  //     await falseLike.save()
  //     res.status(200).json({ value: filterValueTrue.length })
  //   }
  //   else if (falseLike) {
